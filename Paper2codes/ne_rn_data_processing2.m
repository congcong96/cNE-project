function ne_rn_data_processing2(files, DF, roundopt)
...
nefiles = gfn('*rn1*20dft.mat');
            
%%

ne_batch_calc_num_NE_events(nefiles);

%%
ne_batch_save_sta_NEtrain(nefiles);

%%
ne_batch_calc_NE_stamat_with_sta_NEtrain(nefiles);
