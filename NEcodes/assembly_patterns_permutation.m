function AssemblyTemplates = assembly_patterns_permutation(SpikeCount,NumberOfAssemblies, opts)
...
if nargin<3
    opts.threshold.method = 'MarcenkoPastur';
    opts.Patterns.method = 'ICA';
    opts.Patterns.number_of_iterations = 100;
end
